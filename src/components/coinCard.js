...
function CoinCard({status,coinUrl,coinName,coinPrice,coinVolume,marketCap}) {

    return (
        <div className = "rounded-xl neo w-full">
           ...
           <div className="md:mt-5  flex justify-between  h-10">
            ...
            <div className="md:mr-5 neon mr-4 rounded-xl h-6 w-12 md:h-7 md:w-12 text-center">coin</div>
